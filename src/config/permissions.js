...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    subs: [
      ...
      { key: 'inkoopprijzen', label: 'Inkoopprijzen zien',
        kort: 'Inkoopprijs en marge op materialen',
        uitleg: 'Toont de inkoopprijs van materialen — in de materialenbibliotheek, op werkbonregels en in de marge-kolom. Zonder dit recht ziet de gebruiker alleen de verkoopprijs. Dit wordt server-side afgedwongen: de inkoopprijs komt zonder dit recht niet uit de database, ook niet via een directe API-call. Standaard alleen voor admins.' },
