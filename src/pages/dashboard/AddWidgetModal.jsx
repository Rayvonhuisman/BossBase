...
export function AddWidgetModal({ existingTypes, onAdd, onClose, can, has }) {
  ...
  // Verberg widgets waar de gebruiker geen recht voor heeft of die buiten zijn
  // abonnement vallen (zelfde filter als het dashboard), zodat ze ook niet
  // toegevoegd kunnen worden.
  const maySee = w => magWidgetZien(w.type, { can, has });
