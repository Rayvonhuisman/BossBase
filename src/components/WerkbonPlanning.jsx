 ...
 *
 * Voertuigen staan NIET meer hier: die hebben een eigen blok onder de
 * medewerkers (WerkbonVoertuigenBlok). Wat hier blijft is het opruimen — gaat
 * een dag of een persoon eruit, dan vervalt ook zijn plek in een bus.
 */
                        ...
                        return (
                          ...
                          {dubbel.length > 0 && (
                            ...
                            <Driehoek
                              ...
                              kop="Dubbel ingepland"
                              label={`${m.naam} op ${korteDatum(d)}: dubbel ingepland — uitleg`}
                            >
                              {dubbel.length > 0 && (
                                <>
